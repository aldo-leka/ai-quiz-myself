...
export function CountryStrips({ countryData, maxStrips = 3, countriesPerStrip = 10 }: CountryStripsProps) {
                        ...
                        return (
                            <Tooltip key={countryCode}>
                                ...
                                <TooltipContent side="top"
                                                className="bg-black/90 text-white px-3 py-1.5 rounded-md text-xs">
